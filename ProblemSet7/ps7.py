...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        ...
        words = [token.lower().strip(string.punctuation) for token in tokens]
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    """
    triggerClassName = triggerType.capitalize() + 'Trigger'
    if triggerType in ['AND', 'OR', 'NOT']:
        triggerParams = [triggerMap[triggerName] for triggerName in params]
    else:
        triggerParams = [' '.join(params)]

    trigger = globals()[triggerClassName](*triggerParams)
